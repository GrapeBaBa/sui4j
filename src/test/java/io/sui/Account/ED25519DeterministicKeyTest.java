...
public class ED25519DeterministicKeyTest {
    ...
    private int[] path = new int[]{0 | HARDENED_BIT, 1 | HARDENED_BIT, 2 | HARDENED_BIT, 2 | HARDENED_BIT, 1000000000 | HARDENED_BIT};
    ...
    void TestKeyDerivePath() throws Exception {
        ...
        assertEquals(privs[privs.length - 1].toUpperCase(), BaseEncoding.base16().encode(last.getKey()));
