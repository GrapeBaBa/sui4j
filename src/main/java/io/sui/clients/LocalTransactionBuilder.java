...
import static io.sui.models.transactions.TypeTag.SimpleType.u8;
...
import io.sui.bcsgen.TransactionKind.ProgrammableTransaction.Builder;
...
public class LocalTransactionBuilder implements TransactionBuilder {
  ...
  public CompletableFuture<TransactionBytes> pay(
    ...
    CompletableFuture<SuiObjectRef>[] coinRefFutures =
        (CompletableFuture<SuiObjectRef>[])
            inputCoins.stream()
                .map((String id) -> queryClient.getObjectRef(id, new ObjectDataOptions()))
        ...
        .thenApply(
            unused -> {
              ...
              TransactionData transactionData =
                  ProgrammableTransactionBuilder.newPay(
              ...
              transactionBytes.setLocalTxBytes(transactionData);
    ...
    return CompletableFuture.allOf(ArrayUtils.addAll(coinRefFutures, refGasPriceFuture))
        .thenApply(
            unused -> {
              ...
              Tuple3<ObjectID, SequenceNumber, ObjectDigest> gasRef = coins.remove(0);

              TransactionData transactionData =
                  ProgrammableTransactionBuilder.newPaySui(
                      senderAddressBuilder.build(),
                      coins,
                      recs,
                      amounts,
    ...
    return CompletableFuture.allOf(ArrayUtils.addAll(coinRefFutures, refGasPriceFuture))
        .thenApply(
            unused -> {
              ...
              TransactionData transactionData =
                  ProgrammableTransactionBuilder.newPayAllSui(
                      senderAddressBuilder.build(),
                      coins,
  ...
  public CompletableFuture<TransactionBytes> transferSui(
    ...
    CompletableFuture<Long> refGasPriceFuture = queryClient.getReferenceGasPrice();
    CompletableFuture<SuiObjectRef> objRefFuture =
        queryClient.getObjectRef(coin, new ObjectDataOptions());
    return CompletableFuture.allOf(refGasPriceFuture, objRefFuture)
        .thenApply(
            unused -> {
              ...
              TransactionData transactionData =
                  ProgrammableTransactionBuilder.newTransferSui(
                      recipientAddressBuilder.build(),
                      senderAddressBuilder.build(),
                      amount,
                      getObjectRef(objRef),
  ...
  public CompletableFuture<TransactionBytes> transferObject(
    ...
    CompletableFuture<SuiObjectRef> objRefFuture =
        queryClient.getObjectRef(suiObject, new ObjectDataOptions());
    CompletableFuture<Long> refGasPriceFuture = queryClient.getReferenceGasPrice();
    CompletableFuture<SuiObjectRef> gasRefFuture =
        refGasPriceFuture.thenCompose(
            (Function<Long, CompletableFuture<SuiObjectRef>>)
    ...
    return CompletableFuture.allOf(refGasPriceFuture, objRefFuture, gasRefFuture)
        .thenApply(
            unused -> {
              ...
              programmableTransactionBuilder.transferObject(
                  recipientAddressBuilder.build(), getObjectRef(objRef));
              ProgrammableTransaction programmableTransaction =
                  programmableTransactionBuilder.build();
              TransactionKind.ProgrammableTransaction.Builder builder = new Builder();
  ...
  //                                          ObjectID.Builder objectIdBuilder = new
  // ObjectID.Builder();
  ...
  //                                          gasDataBuilder.owner = senderAddressBuilder.build();
  //                                          final TransactionDataV1.Builder
  // transactionDataV1Builder =
  //                                              new TransactionDataV1.Builder();
  //                                          transactionDataV1Builder.kind =
  // singleKindBuilder.build();
            ...
            unused -> {
              ...
              List<ObjectID> depIdObjects =
                  depIds != null
                      ? depIds.stream()
                          .map(
                              objectId -> {
                                AccountAddress.Builder accountAddressBuilder =
                                    new AccountAddress.Builder();
              ...
              List<List<Byte>> modules =
                  compiledModules.stream()
                      ...
                      .collect(Collectors.toList());
              TransactionData transactionData =
                  ProgrammableTransactionBuilder.newModule(
                      senderAddressBuilder.build(),
                      Lists.newArrayList(getObjectRef(objRef)),
                      modules,
                      depIdObjects,
                      gasBudget,
                      refGasPrice);
  ...
  //                  type =
  //                      ((MoveObject) ((SuiObject)
  // objectResponse.getDetails()).getData()).getType();
  //                }
  //              }
  //
  //              if (null == type) {
  ...
  private CompletableFuture<SuiObjectRef> selectGas(
    ...
    if (StringUtils.isNotEmpty(inputGas)) {
      return queryClient.getObjectRef(inputGas, new ObjectDataOptions());
    } else {
  ...
  //    if (moveNormalizedType instanceof MoveNormalizedType.VectorReferenceMoveNormalizedType) {
  //
  //      if (((MoveNormalizedType.VectorReferenceMoveNormalizedType)
  // moveNormalizedType).getVector()
  ...
  //                seqBuilder.value =
  //                    ((SuiObjectOwner.SharedOwner)
  // owner).getShared().getInitial_shared_version();
