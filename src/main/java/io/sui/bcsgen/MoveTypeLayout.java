...
public abstract class MoveTypeLayout {

    abstract public void serialize(com.novi.serde.Serializer serializer) throws com.novi.serde.SerializationError;

    public static MoveTypeLayout deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        switch (index) {
            ...
            default: throw new com.novi.serde.DeserializationError("Unknown variant index for MoveTypeLayout: " + index);
        }
    }
    ...
    public static MoveTypeLayout bcsDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
             throw new com.novi.serde.DeserializationError("Cannot deserialize null array");
        }
        com.novi.serde.Deserializer deserializer = new com.novi.bcs.BcsDeserializer(input);
        MoveTypeLayout value = deserialize(deserializer);
    ...
    public static final class bool extends MoveTypeLayout {
        public bool() {
        }
    ...
    public static final class u8 extends MoveTypeLayout {
        public u8() {
        }
    ...
    public static final class u64 extends MoveTypeLayout {
        public u64() {
        }
    ...
    public static final class u128 extends MoveTypeLayout {
        public u128() {
        }
    ...
    public static final class address extends MoveTypeLayout {
        public address() {
        }
    ...
    public static final class vector extends MoveTypeLayout {
        public final MoveTypeLayout value;

        public vector(MoveTypeLayout value) {
        ...
        static vector load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = MoveTypeLayout.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
    ...
    public static final class struct extends MoveTypeLayout {
        public final MoveStructLayout value;

        public struct(MoveStructLayout value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static struct load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = MoveStructLayout.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
    ...
    public static final class signer extends MoveTypeLayout {
        public signer() {
        }
    ...
    public static final class u16 extends MoveTypeLayout {
        public u16() {
        }
    ...
    public static final class u32 extends MoveTypeLayout {
        public u32() {
        }
    ...
    public static final class u256 extends MoveTypeLayout {
        public u256() {
        }
