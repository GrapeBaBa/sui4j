...
public final class PaySui {
    ...
    public PaySui(java.util.List<com.novi.serde.Tuple3<ObjectID, SequenceNumber, ObjectDigest>> coins, java.util.List<SuiAddress> recipients, java.util.List<@com.novi.serde.Unsigned Long> amounts) {
    ...
    public static PaySui deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
    ...
    public static PaySui bcsDeserialize(byte[] input) throws com.novi.serde.DeserializationError {
        if (input == null) {
             throw new com.novi.serde.DeserializationError("Cannot deserialize null array");
        }
        com.novi.serde.Deserializer deserializer = new com.novi.bcs.BcsDeserializer(input);
        PaySui value = deserialize(deserializer);
