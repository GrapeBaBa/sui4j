...
public abstract class TransactionData {
    ...
    public static final class V1 extends TransactionData {
        public final TransactionDataV1 value;

        public V1(TransactionDataV1 value) {
        ...
        static V1 load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = TransactionDataV1.deserialize(deserializer);
        ...
        public static final class Builder {
            public TransactionDataV1 value;
